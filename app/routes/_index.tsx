      ...
      <body className="bg-gray-100 text-gray-900 font-sans">
        ...
        <main className="p-8">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">About Tailwind CSS</h2>
            <p className="text-lg mb-2">
              ...
              It's<span className="font-bold"> Fast </span> ,{" "} <span className="font-bold"> flexible </span> and{" "}  <span className="font-bold"> reliable </span> and{" "}
              <em>with zero-runtime.</em>
            </p>
            <p className="text-lg mb-2">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">Some Facts about Tailwind CSS</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">Style Forms with Tailwind CSS</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">Alert Box</h2>
