    ...
    return (
        <main className="p-8 bg-white">
            ...
            <div className="flex justify-center space-x-6 mb-8">
                <img className="h-10" src="public/images/logo_1.png" alt="Haier" />
                <img className="h-10" src="public/images/logo_2.png" alt="Whirlpool" />
                <img className="h-10" src="public/images/logo_3.png" alt="Gaggenau" />
                <img className="h-10" src="public/images/logo_4.png" alt="Electrolux" />
                <img className="h-10" src="public/images/logo_5.png" alt="LG" /><br/><br/>
            </div>
